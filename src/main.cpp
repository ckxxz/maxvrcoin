...
uint256 hashGenesisBlock("0x000003e7bbeb63eecab8e5bc959edb8c7b121b19e2773830fd92e95fad5a50de");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // MaxvrCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "MaxvrCoin Signed Message:\n";
...
{
    // MaxvrCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // MaxvrCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
	const char* pszTimestamp = "MaxvrCoin Genesis Start!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("14758afdb0fe123sa23967f1a6713detb05c3rg128e03909a679werdea1f61deb649adfi7f4cef3844325504e51ec1120987d84df7ba0b8d578a4c707423451d5f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1530683219;
        ...
        assert(block.hashMerkleRoot == uint256("0xfcbaf9acc336c14186a7038c122007ed3891986e9d2fe1b34489b57b7e962200"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xe0, 0xa3, 0xcc, 0xef }; // MaxvrCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MaxvrCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MaxvrCoinMiner : ProcessBlock, block not accepted");
    }
